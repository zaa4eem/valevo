...
from services.tournament_update import apply_tournament_update
...
async def main() -> None:
    ...
    tournament_migration = await apply_tournament_update()
    logger.info("Tournament v3 active: %s", tournament_migration)
