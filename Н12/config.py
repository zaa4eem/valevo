...
STAFF_IDS = list(dict.fromkeys(ADMIN_IDS + SUPER_ADMIN_IDS))
SUPPORT_CHAT_ID = _int_env("SUPPORT_CHAT_ID", (SUPER_ADMIN_IDS or ADMIN_IDS or [0])[0])
...
REFERRAL_BONUS_RUB = _float_env("REFERRAL_BONUS_RUB", 350.0)
